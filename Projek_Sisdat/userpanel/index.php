// index untuk user (di folder 'userpanel')
...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom fixed-top">
        <div class="container">
            <h1 class="navbar-brand">Gameery</h1>
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-2" href="game_terjual.html">Library Game</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container container-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="welcome-text">Selamat datang <?php echo $dataUser['nama_pengguna']; ?>! </h2>
                        ...
                        <div class="card-item">
                            ...
                            <div class="card-body-item">
                                ...
                                <div>
                                    ...
                                    <a href="buy_game.php?id=<?php echo $row['game_id']; ?>" class="btn btn-outline-success btn-sm btn-action"><i class="fas fa-cart-shopping"></i> Buy</a>
                                </div>
                            </div>
                        </div>
                    </div>
